...
import Dominance.util.PortReader;
 ...
 */
public class DominanceMain {

    private static final int DEFAULT_PORT = 19347;
    ...
    public static void main(String[] args) {
        ...
        DominancePythonInterface pythonInterface = new DominancePythonInterface(port, botManager);
    ...
    private static void displayWindow(BotManager botManager, int port) {
        ...
        dataPanel.add(new JLabel("I'm the thing controlling the Dominance bot(s), keep me open :)"), BorderLayout.CENTER);
        JLabel botsRunning = new JLabel("Bots running: ");
        dataPanel.add(botsRunning, BorderLayout.CENTER);
        panel.add(dataPanel, BorderLayout.CENTER);
        frame.add(panel);

        URL url = DominanceMain.class.getClassLoader().getResource("icon.png");
